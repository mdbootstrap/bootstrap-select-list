...
Responsive Select list built with Bootstrap 5. Examples include multiselect dropdown, select dropdown with search, placeholders, disabled select and disabled options.

Check out [Bootstrap Select list Documentation](https://mdbootstrap.com/docs/standard/extended/select-list/) for detailed instructions & even more examples.

## Basic example

[Bootstrap Select list:
![Bootstrap 5 Select list](/assets/basic-example.png)](http://localhost:1313/docs/standard/extended/select-list/#section-basic-example)
...
[Bootstrap Select list Multiple:
![Bootstrap 5 Select list](/assets/multiple.png)](https://mdbootstrap.com/docs/standard/extended/select-list/#section-multiple)

[Bootstrap Select list Search:
![Bootstrap 5 Select list](/assets/search.png)](https://mdbootstrap.com/docs/standard/extended/select-list/#section-search)

[Bootstrap Select list Placeholder:
![Bootstrap 5 Select list](/assets/placeholder.png)](https://mdbootstrap.com/docs/standard/extended/select-list/#section-placeholder)

[Bootstrap Select list Disabled select:
![Bootstrap 5 Select list](/assets/disabled-select.png)](https://mdbootstrap.com/docs/standard/extended/select-list/#section-disabled-select)

[Bootstrap Select list Disabled options:
![Bootstrap 5 Select list](/assets/disabled-options.png)](https://mdbootstrap.com/docs/standard/extended/select-list/#section-disabled-options)
